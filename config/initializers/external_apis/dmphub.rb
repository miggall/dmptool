...
Rails.configuration.x.dmphub.api_base_url = Rails.configuration.x.system.dmphub_url
...
Rails.configuration.x.dmphub.active = Rails.configuration.x.system.dmphub_client_id
